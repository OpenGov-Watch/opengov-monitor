...
export const expiredClaimsColumns: ColumnDef<ExpiredClaim>[] = [
  {
  ...
  {
    accessorKey: "days_since_expiry",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Days Ago" />
    ),
    cell: ({ row }) => {
      const days = row.getValue("days_since_expiry") as number | null;
