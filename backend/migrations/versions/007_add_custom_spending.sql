-- Migration: Add Custom Spending table
-- Version: 007
-- Created: 2026-01-15
-- Description: Add user-managed custom spending table and update all_spending view

-- Create Custom Spending table
CREATE TABLE IF NOT EXISTS "Custom Spending" (
...
-- Recreate all_spending view with Custom Spending union
