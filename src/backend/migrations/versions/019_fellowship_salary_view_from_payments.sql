-- Migration: Fellowship Salary view from individual payments
-- Version: 019
-- Created: 2026-01-21
-- Description: Change all_spending view to aggregate Fellowship Salary from individual payments
--              instead of from cycles. This enables showing both DOT and USDC amounts.
