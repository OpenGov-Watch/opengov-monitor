-- Migration: Rename Fellowship Salary Cycles columns from DOT to USDC
-- Version: 005
-- Created: 2026-01-14
-- Description: Rename budget_dot, registered_paid_amount_dot, total_registrations_dot, unregistered_paid_dot to *_usdc

DROP VIEW IF EXISTS all_spending;

ALTER TABLE "Fellowship Salary Cycles" RENAME COLUMN "budget_dot" TO "budget_usdc";
ALTER TABLE "Fellowship Salary Cycles" RENAME COLUMN "registered_paid_amount_dot" TO "registered_paid_amount_usdc";
ALTER TABLE "Fellowship Salary Cycles" RENAME COLUMN "total_registrations_dot" TO "total_registrations_usdc";
ALTER TABLE "Fellowship Salary Cycles" RENAME COLUMN "unregistered_paid_dot" TO "unregistered_paid_usdc";
