-- Migration: Fix Fellowship Salary USDC column mapping
-- Version: 016
-- Created: 2026-01-21
-- Description: Fellowship salaries are paid in USDC, not DOT. Move values from DOT columns to USDC_component.
